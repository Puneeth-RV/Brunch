        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '64px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              <img src="/logo.png" alt="Brunch Logo" style={{ height: '40px', width: '40px', objectFit: 'contain', backgroundColor: '#ffffff', borderRadius: '10px', padding: '2px' }} />
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1.5rem' }}>
            <img src="/logo.png" alt="Brunch" style={{ height: '80px', width: '80px', objectFit: 'contain', backgroundColor: '#ffffff', borderRadius: '16px', padding: '4px' }} />
          </div>
